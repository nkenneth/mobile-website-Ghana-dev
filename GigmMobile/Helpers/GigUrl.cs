namespace GIGMWEB.Models
{
    public class GigUrl
    {
        ...
        public static string GetDepartureTerminalsByCountryCode = BaseUrl + "api/terminals/terminalbycountrycode/";
        public static string GetTravelDocumentUrl = BaseUrl + "api/traveldocument";
        ...
        public static string GigmsGetCountryDetails = BaseUrl + "api/countries/getcountrybycode/";
        ...
        public static string ProcessPaySwitchPayment = BaseUrl + "api/bookings/ProcessTheTellerPayment/";
