		...
		// else {
			...
			// else {
				...
				.done(function (response) {
					...
					if (response.ShortDescription === "SUCCESS" && response.Object.Message !== "Account is inactive" ) {
			...
			window.location.replace("dashboard");
				...
				swal({
						...
						if (response.Object.Message === "Account is inactive") {
							var email = response.Object.Email, phone = response.Object.PhoneNumber;
