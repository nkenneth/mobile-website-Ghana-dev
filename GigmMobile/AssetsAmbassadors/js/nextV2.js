...
$('.proceed').on('click', function (e) {
	...
	if (radioValue === "nysc") {
		...
		$('.campus').hide();
		//$('.campus').hide();
		$('.campus').css('display', 'none !important');
		$('.school').css('display', 'none !important');
		//$('.school').hide();
		//$('#campus').attr('required', 'required');
...
{
	type: 'post',
//	url: 'https://client.thegigmobility.com/api/CampusAmbassador/requestverificationbyemail',
	url: urler + "requestverificationbyemail",
	data: {
...
{
	type: 'post',
	// url: 'https://client.thegigmobility.com/api/CampusAmbassador/requestverificationbyphone/' + localStorage.getItem("phoneVerify"),
	url: urler + "requestverificationbyphone/" + localStorage.getItem("phoneVerify"),
	//data: {
	//	"Email": localStorage.getItem("emailVerify"),
	//	"HashedVerifyData": localStorage.getItem("HashCode")
	//},
...
{
	type: 'post',
	url: urler + "verifybyphone/" + localStorage.getItem("phoneVerify") + "/" + otpCode,
	//data: {
	//	"Email": localStorage.getItem("emailVerify"),
	//	"HashedVerifyData": localStorage.getItem("HashCode")
	//},
