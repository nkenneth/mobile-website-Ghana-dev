...
namespace GigmMobile.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult deskbooking()
        {
            return base.View();
        }
        ...
        public ActionResult SelectBus2()
        {
            return base.View();
        }
        ...
        public ActionResult Passenger2()
        {
            return base.View();
        }
        ...
        public ActionResult PaySwitchPaymentView(string amount, string transid , string customer_email, string currency)
        {
            PaySwitchResponseModel paySwitchResponseModel = new PaySwitchResponseModel();
            var APIKey = ConfigurationManager.AppSettings["thetellerKey"];
            var merchantKey = ConfigurationManager.AppSettings["merchantId"];
            var redirect_url = ConfigurationManager.AppSettings["theTellerResponseUrl"];
            var buttonurl = ConfigurationManager.AppSettings["buttonurl"];


            paySwitchResponseModel.APIKey = APIKey;
            paySwitchResponseModel.merchant = merchantKey;
            paySwitchResponseModel.redirect_url = redirect_url;
            paySwitchResponseModel.customer_email = customer_email;
            paySwitchResponseModel.amount = amount;
            paySwitchResponseModel.transid = transid;
            paySwitchResponseModel.buttonurl = buttonurl;
            paySwitchResponseModel.Currency = currency;

            return base.View(paySwitchResponseModel);
        }

        //public ActionResult PaySwitchPaymentView(TheTellerPaymentResponse paramter)
        //{
        //    PaySwitchResponseModel paySwitchResponseModel = new PaySwitchResponseModel();
        //    var APIKey = ConfigurationManager.AppSettings["thetellerKey"];
        //    var merchantKey = ConfigurationManager.AppSettings["merchantId"];
        ...
        //    paySwitchResponseModel.merchant = merchantKey;
        //    paySwitchResponseModel.redirect_url = redirect_url;
        //    paySwitchResponseModel.customer_email = paramter.customer_email;
        //    paySwitchResponseModel.amount = paramter.amount;
        //    paySwitchResponseModel.transid = paramter.transid;
