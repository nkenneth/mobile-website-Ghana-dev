...
//	  	return Promise.all(
//		  cacheNames.filter(function (preCacheName) {
//		  	// Return true if you want to remove this cache,
//		  	// but remember that caches are shared across
//		  	// the whole origin
//		  }).map(function (preCacheName) {
...
////	//var urlsToCache = ['/Ambassadors']; // <-- Add more URLs you would like to cache.

////	// Store core files in a cache (including a page to display when offline)
////	function updateStaticCache() {
////		return caches.open(version)
////            .then(function (cache) {
////            	return cache.addAll(preCacheName);
////            });
////	}
...
//function clearCache(preCacheFiles) {
//	if ('caches' in window) {
//		return caches.delete(preCacheFiles);
//	}
//}

//clearCache(preCacheName);
