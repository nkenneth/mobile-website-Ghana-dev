$(function() {
  $(".btn").click(function(event) {
    ...
    $.ajax({
      url: "https://api.formbucket.com/f/buk_wE2h29T5VckxxEQhQTpcB9y6",
      type: "POST",
      crossDomain: true,
      headers: {
      ...
      .done(function(response) {
        ...
        swal({
          title: "Success!",
          text:
            "Thanks for applying to be a GIGM Ambassador. We will review applications on a regular basis and will send you an email if your application is accepted.",
          icon: "success"
        }).then(function() {
