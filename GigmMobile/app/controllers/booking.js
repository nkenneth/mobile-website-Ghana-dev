(function() {
    ...
    function booking($route, $localstorage, $scope, common, datacontext) {
        ...
        vm.next = function() {
            ...
            swal({
                title: "Dear Guest",
                text: "Please note that irrespective of schedules selected, our buses are only able to leave after curfew hours elapse in your state of departure, we are commited to ensuring you have a safe and comfortable experience when you travel with us.",
                //icon: "warning",
                //buttons: true,
                //dangerMode: true,
            })
            ...
            //if (result) {
            //    swal("We are sorry but please note that this schedule is temporarily unavailable due to the current #EndSARS protest.");
            //}
            ...
            datacontext.loadBusForDay(result).then(function(d) {
               ...
               // console.log("res", d);
                ...
                window.location.href = 'SelectBus2';
